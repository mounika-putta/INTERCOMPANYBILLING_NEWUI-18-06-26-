...
function Registration() {
  ...
  return (
    ...
    >
      {/* Top bar: brand on the left, login link on the right */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
          <Box
            component="img"
            src="/files/assets/images/ITSALOGO.png"
            alt="ITSA"
            onError={(e) => {
            ...
            sx={{ height: 30 }}
          />
          <Typography sx={{ fontWeight: 700, color: colors.ink, fontSize: '1.05rem' }}>
        ...
        <Typography variant="body2" sx={{ color: colors.inkSoft }}>
          ...
          <Box
            component="span"
            onClick={handleBack}
            sx={{ color: colors.brand, fontWeight: 700, cursor: 'pointer', '&:hover': { textDecoration: 'underline' } }}
          >
            Login
          </Box>
        </Typography>
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          >
            <Icon name="user-plus" size={17} color={colors.brand} />
          </Box>
          <Box>
            <Typography variant="h5" sx={{ fontWeight: 800, color: colors.brand, lineHeight: 1.2 }}>
              User Registration
            </Typography>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, justifyContent: 'flex-end', mt: 0.5 }}>
          ...
          <Button type="submit" variant="contained" size="small" loading={formik.isSubmitting}
